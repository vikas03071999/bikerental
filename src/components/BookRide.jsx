            ...
            <div className='bookrideWrapper flex items-center px-8 py-8 border bg-gradient-to-t from-white via-slate-200 to-white'>
                <div className='form flex flex-col gap-10'>
                    ...
                    <div className='inputSection flex items-center flex-wrap gap-14 w-full'>
                        ...
                        <div className='singleInput flex basis-1/4 flex-col gap-3'>
                            <label htmlFor='pickup' className='text-xl font-semibold'><i className="fa-solid fa-location-dot text-[#646cff]"></i> Pick up <span className='text-[#646cff]'>*</span></label>
                        ...
                        <div className='singleInput flex basis-1/4 flex-col gap-3'>
                            <label htmlFor='dropoff' className='text-xl font-semibold'><i className="fa-solid fa-motorcycle text-[#646cff]"></i> Drop off <span className='text-[#646cff]'>*</span></label>
                        ...
                        <div className='singleInput flex basis-1/4 flex-col gap-3'>
                            <label htmlFor='pickupdate' className='text-xl font-semibold'><i class="fa-regular fa-calendar-days text-[#646cff]"></i> Pick up date <span className='text-[#646cff]'>*</span></label>
                            <input type='date' className='text-[#a5a3a3] outline-none px-3 py-2'/>
                        </div>
                        <div className='singleInput flex basis-1/4 flex-col gap-3'>
                            <label htmlFor='pickupdate' className='text-xl font-semibold'><i class="fa-regular fa-calendar-days text-[#646cff]"></i> Drop off date <span className='text-[#646cff]'>*</span></label>
                            <input type='date' className='text-[#a5a3a3] outline-none px-3 py-2'/>
                        </div>
